...
import { userService, positionService, applicationService, reportService } from "../../services/apiService";
...
const AdminDashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      setLoading(true);
      const [users, positions, applications] = await Promise.all([
      ...
      setStats({
        ...
        activePositions: Array.isArray(positions) 
