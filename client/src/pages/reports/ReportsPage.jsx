...
const ReportsPage = () => {
  ...
  const renderStatusChip = (label, value) => (
    <div className="flex items-center justify-between bg-white/70 rounded-md px-3 py-2 shadow-sm">
    ...
    <div className="container mx-auto px-4 py-8 mt-16">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600">
            Position-wise, college-wise, process, interviewer, date, technology,
            and experience views. Admin/HR only.
          </p>
        </div>
        <form
          className="flex items-center space-x-3 bg-white shadow-sm px-4 py-2 rounded-lg"
          onSubmit={(e) => {
            e.preventDefault();
            fetchSummary();
          }}
        >
          ...
          <button
            type="submit"
            className="bg-[var(--primary-color)] text-white px-3 py-2 rounded-lg hover:bg-[var(--primary-color-dark)]"
          >
            Refresh
          </button>
        </form>
      ...
      {summary && (
        <div className="space-y-8">
              ...
              <table className="min-w-full text-sm">
                ...
                <tbody>
                  {(summary.positionReports || []).map((row) => (
                    <tr key={row.positionId} className="border-b last:border-0">
          ...
          {/* College-wise */}
          <section className="bg-white shadow-sm rounded-lg p-4">
            <h2 className="text-lg font-semibold mb-3">College-wise Report</h2>
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                <thead className="bg-gray-50">
                  <tr>
          ...
          <section className="bg-white shadow-sm rounded-lg p-4">
            ...
            >
              ...
              <div className="flex flex-col text-sm">
                <label className="text-gray-500">Min Experience (years)</label>
                <input
                  type="number"
                  className="border rounded px-2 py-1"
              ...
              <div className="flex flex-col text-sm">
                <label className="text-gray-500">Max Experience (years)</label>
                <input
                  type="number"
                  className="border rounded px-2 py-1"
